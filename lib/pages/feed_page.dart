              ...
              Container(
                ...
                child:Row(
                  ...
                  children:[
                    ...
                    Text('Watch All',style:TextStyle(fontSize:14,fontFamily:'Roboto')),
                  ],
                ),
              ),
            //  #stories
    ...
    return Column(
      children:[
       Container(
        ...
        SizedBox(height:10),
        Text(item.userNme,style:TextStyle(color:Colors.grey[700],fontSize:15,fontFamily:'Roboto')),
      ],
    );
  }
//  #post widget
          ...
          //  #icons
            ...
            Container(
              ...
              child:Text.rich(
                TextSpan(
                  text:'Liked by ',
                  style:TextStyle(fontSize:15,fontFamily:'Roboto',color:Colors.grey[700]),
                  children:[
                    TextSpan(
            ...
            Container(
              ...
              child:RichText(
                ...
                text:TextSpan(
                  ...
                  children:[
                    TextSpan(text:item.caption,style:TextStyle(color:Colors.black,fontWeight:FontWeight.normal,fontSize:15),),
                  ],
                ),
              ),
            ),
            ...
            Container(
              ...
              margin:EdgeInsets.symmetric(horizontal: 10),
              child:Text('February 2020',style:TextStyle(color:Colors.grey[500],fontFamily:'Roboto'),textAlign:TextAlign.start,),
            ),
          ],
        ),
    );
